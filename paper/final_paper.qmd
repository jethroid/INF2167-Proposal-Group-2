...
```{r}
ggplot() +
  # map the federal electoral districts as the base map
  geom_sf(data = fed_boundaries, fill = "lightblue") +
  
  # map the location of news outlets
  geom_sf(data = news_fed, size = 1, alpha = 0.7) +
  labs(
...
## III. Merging Election Results and Local News Data
